...
TEST_F(OrderBookTest, LastUpdateTimestamp) {
    ...
    book.update(initialBids, initialAsks);
    ...
    std::this_thread::sleep_for(std::chrono::milliseconds(100));  // Longer delay
    book.update(newPriceBids, initialAsks);  // Same values
...
TEST_F(OrderBookTest, PriceLevelEdgeCases) {
    ...
    book.update(smallBids, emptyAsks);
    ...
    book.update(largeBids, emptyAsks);
    ...
    book.update(zeroBids, emptyAsks);
    ...
    book.update(smallPriceBids, emptyAsks);
    ...
    book.update(smallQtyBids, emptyAsks);
    ...
    book.update(smallQtyBids, smallAsks);
    ...
    book.update(smallQtyBids, smallPriceAsks);
...
TEST_F(OrderBookTest, StateTransitions) {
    ...
    book.update(emptyBids, emptyAsks);
