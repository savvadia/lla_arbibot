...
#
get_filename_component(filename "/Users/dianasavvatina/repo/lla_arbibot/_deps/websocketpp-subbuild/websocketpp-populate-prefix/src/0.8.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/dianasavvatina/repo/lla_arbibot/_deps/websocketpp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-websocketpp-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-websocketpp-populate${i}")
